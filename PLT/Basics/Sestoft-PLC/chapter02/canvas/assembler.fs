...
let rec assemble instructions =
    match instructions with
        | [] -> []
        | Cst i :: instr -> [0; i] @ (assemble instr)
        | Var v :: instr -> [1; v] @ assemble instr
        | Add :: instr -> [2] @ assemble instr
        | Sub :: instr -> [3] @ assemble instr 
        | Mul :: instr -> [4] @ assemble instr
        | Div :: instr -> [5] @ assemble instr 
        | Mod :: instr -> [6] @ assemble instr
        | Equ :: instr -> [7] @ assemble instr 
        | Neq :: instr -> [8] @ assemble instr 
        | Max :: instr -> [9] @ assemble instr 
        | Min :: instr -> [10] @ assemble instr
        | Pop :: instr -> [11] @ assemble instr
        | Swp :: instr -> [12] @ assemble instr
...
write_bte s1 "chapter02/canvas/assembled/expression1.svm"
write_bte s2 "chapter02/canvas/assembled/expression2.svm"
write_bte s3 "chapter02/canvas/assembled/expression3.svm"
